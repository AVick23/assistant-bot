...
SETTINGS = {
    "items_per_page": 5,
    "max_history": 10,       # История сообщений
    "inactivity_hours": 24,
    "min_bm25_score": 2.5    # Минимальный порог релевантности
}
...
SYNONYMS = {
    ...
    # Оставляем синонимы для расширения запросов пользователя (не для базы знаний)
}
